...
<head>
    ...
    <title>Users Receipt pdf generator</title>
</head>
<body>
        ...
        <div class="col-md-10">
            ...
            <div class="panel panel-default plain" id="dash_0">
                ...
                <div class="panel-body p30">
                    <div class="d-flex p-2"><h2>Computer Science eBook Club </h2></div>
                    <div class="row">
                        <!-- Start .row -->
                        <div class="col-lg-6">
                            <!-- col-lg-6 start here -->
                            <div class="clearfix">
                                <img width="100" src="assets/img/unn2_logo.jpg" alt="UNN Logo">
                            {{--<div class="invoice-logo" style=" float: left; padding: 15px; "><img width="100" src="assets/img/logo.jpg" alt="gaplink Logo">--}}
                        ...
                        <div class="col-lg-12">
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-center">{{($recipetDetails[0]->amount- $recipetDetails[0]->fees)*0.01}} NGN</td>
                                            </tr>
                                            <tr>
                                                <td>Network services charges </td>
                                                {{--<td class="text-center">1</td>--}}
                                                <td class="text-center">{{$recipetDetails[0]->fees*0.01}} NGN</td>
                                            </tr>
                                            {{--<tr>
                                        ...
                                        <tfoot>
                                            <tr>
                                                ...
                                                <th class="text-center">{{$recipetDetails[0]->amount*0.01}} NGN</th>
                                            </tr>
                                            <tr>
                                                <th colspan="2" class="text-right">20% VAT:</th>
                                                <th class="text-center">{{$recipetDetails[0]->amount*0.0002}} NGN</th>
                                            </tr>
                            ...
                            <div class="invoice-footer mt25">
                                   <p class="text-center">This recipet was generated on {{date("l jS \of F Y h:i:s A", strtotime($current ))}}  {{--<a href="/pdfpreview" class="btn btn-default ml15"><i class="fa fa-print mr5"></i> Preview</a>  @if($pdfConver) <a href="{{ route('pdf.generate') }}" class="btn btn-primary">Generate PDF</a> @endif--}} </p>
                            </div>
                        </div>
                        <!-- col-lg-12 end here -->
                    </div>
