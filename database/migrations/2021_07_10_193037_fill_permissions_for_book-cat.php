...
class FillPermissionsForBookCat extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookCat constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.book-cat',
            'admin.book-cat.index',
            'admin.book-cat.create',
            'admin.book-cat.show',
            'admin.book-cat.edit',
            'admin.book-cat.delete',
            'admin.book-cat.bulk-delete',
        ]);
