...
class FillPermissionsForBookType extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookType constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.book-type',
            'admin.book-type.index',
            'admin.book-type.create',
            'admin.book-type.show',
            'admin.book-type.edit',
            'admin.book-type.delete',
            'admin.book-type.bulk-delete',
        ]);
