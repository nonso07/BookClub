...
class FillPermissionsForBookUpload extends Migration
{
    /**
    ...
    /**
     * FillPermissionsForBookUpload constructor.
     */
    public function __construct()
    {
        ...
        $permissions = collect([
            'admin.book-upload',
            'admin.book-upload.index',
            'admin.book-upload.create',
            'admin.book-upload.show',
            'admin.book-upload.edit',
            'admin.book-upload.delete',
            'admin.book-upload.bulk-delete',
        ]);
